...
Hydrodynamic::LegacyAssemblyData::Matrix::Scratch<dim>(mapping,
                                                 ...
                                                 allocate_traction),
strong_form_options(this->n_q_points,
                    allocate_gravity_field),
weak_form_options(),
density_strong_form_options(this->n_q_points,
...
density_strong_form_options(data.density_strong_form_options),
density_weak_form_options(data.density_weak_form_options),
