...
template class PeriodicBoundaryData<2>;
template class PeriodicBoundaryData<3>;

template class BoundaryConditionsBase<2>;
template class BoundaryConditionsBase<3>;
