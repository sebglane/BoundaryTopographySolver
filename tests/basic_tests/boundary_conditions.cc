...
int main(void)
{
  try
  {
    ...
    BoundaryConditions::scalar_boundary_condition_test<2>();
    BoundaryConditions::scalar_boundary_condition_test<3>();

    BoundaryConditions::vector_boundary_condition_test<2>();
    BoundaryConditions::vector_boundary_condition_test<3>();
