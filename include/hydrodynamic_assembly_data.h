...
public:
  ...
  void assign_optional_shape_functions_system_local(
    const FEValuesExtractors::Vector &velocity,
    const FEValuesExtractors::Scalar &pressure,
    const unsigned int                q_point_index);

  void assign_optional_shape_functions_rhs_local(
    const FEValuesExtractors::Vector &velocity,
    const FEValuesExtractors::Scalar &pressure,
    const unsigned int                q_point_index);

  void assign_optional_shape_functions_system_local_boundary(
    const FEValuesExtractors::Vector &velocity,
    const unsigned int                q_point_index);
