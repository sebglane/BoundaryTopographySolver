...
template <int dim>
class CavityProblem : public HydrodynamicProblem<dim, ParallelTriangulation<dim>, TrilinosContainer>
{
public:
...
:
HydrodynamicProblem<dim, ParallelTriangulation<dim>, TrilinosContainer>(parameters),
left_bndry_id(0),
right_bndry_id(1),
bottom_bndry_id(2),
top_bndry_id(3),
...
front_bndry_id(5)
{
  if (Utilities::MPI::this_mpi_process(this->triangulation.get_communicator()) == 0)
